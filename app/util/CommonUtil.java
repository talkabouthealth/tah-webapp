...
public class CommonUtil {
	...
	/**
	 * Generates random email as 'member'+number
	 * @param checkUnique return only unique name?
	 * @return
	 */
	public static String generateRandomEmail(boolean checkUnique) {
		 String USER_EMAIL="fake_email";
		 String EMAIL_SUFFIX= "@aim.com";
		String email = null;
		Random random = new Random();
		while (true) {
			int num = random.nextInt(10000)+1;
			email = USER_EMAIL+num;
			if (!checkUnique || TalkerDAO.isEmailUnique(email)) {
